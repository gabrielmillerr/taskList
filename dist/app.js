"use strict";
const app = {
    inputElement: document.querySelector(".new-task-input"),
    btnAddTarefa: document.querySelector(".new-task-button"),
    tarefasContainer: document.querySelector(".tasks-container"),
    lidarAddTarefa() {
